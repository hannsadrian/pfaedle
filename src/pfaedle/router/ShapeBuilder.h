...
public:
  ...
  shapeify(const TripTrie<pfaedle::gtfs::Trip> *trie, HopCache *hopCache) const;
...
private:
  ...
  getGtfsShape(const EdgeListHops &shp, pfaedle::gtfs::Trip *t,
               size_t numOthers, const RoutingAttrs &rAttrs,
  ...
  std::map<size_t, router::EdgeListHops>
  route(const TripTrie<pfaedle::gtfs::Trip> *trie, const EdgeCandMap &ecm,
  ...
  void shapeWorker(
      ...
      std::atomic<size_t> *droppedTrips,
